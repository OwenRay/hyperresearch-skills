...
description: >-
  Step 16 of HYPERRESEARCH V8 — a readability-recommender emits JSON suggestions the orchestrator applies selectively.
...
#                 context="vault_tag=<vault_tag>; from step hyperresearch-readability-recommender subagent>")
# Spawn one delegate_task per subagent; issue them in a single turn for parallelism.
# Original subagent_type was: `hyperresearch-readability-recommender`
prompt: |
