...
description: >-
  Step 3 of HYPERRESEARCH V8 — pair contradictions across the corpus into ranked fight clusters and extract consensus claims.
...
- **full tier:** Invoke `skill_view(name="hyperresearch-4-loci-analysis")`
