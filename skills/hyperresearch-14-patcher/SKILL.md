...
description: >-
  Step 14 of HYPERRESEARCH V8 — a patcher subagent (Read+Edit only) applies critic findings as surgical Edit hunks to the report.
...
#                 context="vault_tag=<vault_tag>; from step hyperresearch-patcher subagent>")
# Spawn one delegate_task per subagent; issue them in a single turn for parallelism.
# Original subagent_type was: `hyperresearch-patcher`
prompt: |
...
```
skill_view(name="hyperresearch-14-5-cite-check")
```
