...
description: >-
  Step 14.5 of HYPERRESEARCH V8 — verify that each citation in the report actually supports the sentence it backs.
...
#                 context="vault_tag=<vault_tag>; from step hyperresearch-cite-checker subagent>")
# Spawn one delegate_task per subagent; issue them in a single turn for parallelism.
# Original subagent_type was: `hyperresearch-cite-checker`
prompt: |
...
Return to the entry skill and invoke `skill_view(name="hyperresearch-15-polish")`.
