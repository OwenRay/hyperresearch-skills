...
description: >-
  Step 6 of HYPERRESEARCH V8 — reconcile the depth investigators' committed positions across loci into comparisons.md.
...
```
skill_view(name="hyperresearch-7-source-tensions")
```
