...
description: >-
  Step 11 of HYPERRESEARCH V8 — write a synthesis plan + outline, then spawn a synthesizer subagent (two-pass) to assemble final_report.md.
...
#                 context="vault_tag=<vault_tag>; from step hyperresearch-synthesizer subagent>")
# Spawn one delegate_task per subagent; issue them in a single turn for parallelism.
# Original subagent_type was: `hyperresearch-synthesizer`
prompt: |
...
```
skill_view(name="hyperresearch-12-critics")
```
