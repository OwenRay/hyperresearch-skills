...
description: >-
  Step 1 of the HYPERRESEARCH V8 pipeline — turn the canonical research query into a scaffold, a prompt-decomposition (tier + modality), a coverage matrix, and per-module plans.
...
```
skill_view(name="hyperresearch-2-width-sweep")
```
