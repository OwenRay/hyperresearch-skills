...
description: >-
  Step 9 of HYPERRESEARCH V8 — pull the top claims with verbatim quotes into evidence-digest.md for the drafting step.
...
```
skill_view(name="hyperresearch-10-triple-draft")
```
