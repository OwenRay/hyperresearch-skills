...
description: >-
  Step 15 of HYPERRESEARCH V8 — a polish-auditor (Read+Edit) fixes hygiene and runs a readability pass on the report.
...
#                 context="vault_tag=<vault_tag>; from step hyperresearch-polish-auditor subagent>")
# Spawn one delegate_task per subagent; issue them in a single turn for parallelism.
# Original subagent_type was: `hyperresearch-polish-auditor`
prompt: |
...
```
skill_view(name="hyperresearch-16-readability-audit")
```
